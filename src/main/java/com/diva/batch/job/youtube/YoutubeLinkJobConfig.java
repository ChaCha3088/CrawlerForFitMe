...
//
//import static com.diva.batch.entity.QSong.songOld;
//
//@Slf4j
//@Configuration
...
//
//    @Bean
//    public QuerydslPagingItemReader<SongOld> youtubeLinkJob_reader() {
//        // 1. No Offset 옵션
...
//                .selectFrom(songOld)
//                .where(songOld.youtubeFile.id.isNull())
//        );
//    }
//
//    private ItemProcessor<SongOld, SongOld> youtubeLinkJob_processor() {
//        return song -> {
//            // 이미 유튜브 링크가 있는 경우
...
//
//    @Bean
//    public JpaItemWriter<SongOld> youtubeLinkJob_writer() {
